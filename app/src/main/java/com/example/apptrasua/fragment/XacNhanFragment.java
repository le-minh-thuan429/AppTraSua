...
import com.example.apptrasua.Adapter.AdapterDonHang;
...
public class XacNhanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapterDonHang=new AdapterDonHang(getListDonHang(trangthai), getContext());
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getContext(), RecyclerView.VERTICAL,false);
        listDH.setLayoutManager(linearLayoutManager);
        listDH.setAdapter(adapterDonHang);
