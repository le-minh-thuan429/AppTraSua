...
public class AdapterSanPhamTheoLoai extends RecyclerView.Adapter<AdapterSanPhamTheoLoai.SanPhamView> {
    ...
    public AdapterSanPhamTheoLoai(ArrayList<SanPham> arrayList, Context context) {
    ...
    public SanPhamView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adaptersanphamtheoloai, parent, false);
