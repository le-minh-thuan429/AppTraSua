...
public class AdapterSanPhamTuongTu extends RecyclerView.Adapter<AdapterSanPhamTuongTu.SanPhamView> {
    ...
    public SanPhamView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_sptuongtu, parent, false);
    ...
    public void onBindViewHolder(@NonNull SanPhamView holder, int position) {
        ...
        Glide.with(context).load(sanPham.getLinkAnh()).into(holder.img);

        holder.layout_spTT.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class SanPhamView extends RecyclerView.ViewHolder {
        ...
        public SanPhamView(@NonNull View itemView) {
            ...
            layout_spTT=itemView.findViewById(R.id.layout_spTT);
